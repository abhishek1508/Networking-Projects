...
public class WeatherForecast extends Activity {
	...
	private class DownloadWeatherData extends
		...
		protected void onPreExecute() {
			// TODO Auto-generated method stub
			super.onPreExecute();
			progress = ProgressDialog.show(WeatherForecast.this, "Wait",
					"Your weather is downloading");
		}
			...
			for (String weather_forecast : params) {
				...
				if (url != null) {
					...
					try {
						...
						/*
						 * x-api-key: An API key is required to access
						 * OpenWeatherMap API. This key can be obtained either
						 * by registering on their website or by using a common
						 * key x-api-key.
						 */
						if (connection != null) {
			...
			try {
				...
				if (result != null) {
					...
					if (val != null) {
						...
						temp1.setText(val.convert_dble_to_string(val
								.getObjectJSONDouble(json_one, "temp", "day"))
								+ (char) 0x00b0 + "C");
						min_temp1.setText(val.convert_dble_to_string(val
								.getObjectJSONDouble(json_one, "temp", "min"))
								+ (char) 0x00b0 + "C");
						max_temp1.setText(val.convert_dble_to_string(val
								.getObjectJSONDouble(json_one, "temp", "max"))
								+ (char) 0x00b0 + "C");
						cond1.setText(val.getArrayJSON(json_one, "weather",
								"description"));
						windspeed1
								.setText(json_one.getString("speed") + " mps");
						...
						temp2.setText(val.convert_dble_to_string(val
								.getObjectJSONDouble(json_two, "temp", "day"))
								+ (char) 0x00b0 + "C");
						min_temp2.setText(val.convert_dble_to_string(val
								.getObjectJSONDouble(json_two, "temp", "min"))
								+ (char) 0x00b0 + "C");
						max_temp2.setText(val.convert_dble_to_string(val
								.getObjectJSONDouble(json_two, "temp", "max"))
								+ (char) 0x00b0 + "C");
						cond2.setText(val.getArrayJSON(json_two, "weather",
								"description"));
						windspeed2
								.setText(json_two.getString("speed") + " mps");
